...
# Form implementation generated from reading ui file 'allPaymentsOfPurchaseOrders.ui'
#
...
class Ui_allPaymetsOfPurchaseOrders(object):
    ...
    def retranslateUi(self, allPaymetsOfPurchaseOrders):
        ...
        self.treeWidget.headerItem().setText(0, _translate("allPaymetsOfPurchaseOrders", "ID"))
        self.treeWidget.headerItem().setText(1, _translate("allPaymetsOfPurchaseOrders", "Date"))
        self.treeWidget.headerItem().setText(2, _translate("allPaymetsOfPurchaseOrders", "Purchase Order Id"))
        self.treeWidget.headerItem().setText(3, _translate("allPaymetsOfPurchaseOrders", "Supplier"))
        self.treeWidget.headerItem().setText(4, _translate("allPaymetsOfPurchaseOrders", "Method"))
        self.treeWidget.headerItem().setText(5, _translate("allPaymetsOfPurchaseOrders", "Amount"))
        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        self.treeWidget.topLevelItem(0).setText(0, _translate("allPaymetsOfPurchaseOrders", "1"))
        self.treeWidget.topLevelItem(0).setText(1, _translate("allPaymetsOfPurchaseOrders", "1/1/21/"))
        self.treeWidget.topLevelItem(0).setText(2, _translate("allPaymetsOfPurchaseOrders", "1009"))
        self.treeWidget.topLevelItem(0).setText(3, _translate("allPaymetsOfPurchaseOrders", "Ashfaq Chemicals"))
        self.treeWidget.topLevelItem(0).setText(4, _translate("allPaymetsOfPurchaseOrders", "Cash"))
        self.treeWidget.topLevelItem(0).setText(5, _translate("allPaymetsOfPurchaseOrders", "Rs 50000"))
        self.treeWidget.topLevelItem(1).setText(0, _translate("allPaymetsOfPurchaseOrders", "2"))
        self.treeWidget.topLevelItem(1).setText(1, _translate("allPaymetsOfPurchaseOrders", "1/1/21"))
        self.treeWidget.topLevelItem(1).setText(2, _translate("allPaymetsOfPurchaseOrders", "1008"))
        self.treeWidget.topLevelItem(1).setText(3, _translate("allPaymetsOfPurchaseOrders", "Highlight Seeds"))
        self.treeWidget.topLevelItem(1).setText(4, _translate("allPaymetsOfPurchaseOrders", "Check"))
        self.treeWidget.topLevelItem(1).setText(5, _translate("allPaymetsOfPurchaseOrders", "Rs 5,06,000"))
        self.treeWidget.topLevelItem(2).setText(0, _translate("allPaymetsOfPurchaseOrders", "3"))
        self.treeWidget.topLevelItem(2).setText(1, _translate("allPaymetsOfPurchaseOrders", "1/1/21"))
        self.treeWidget.topLevelItem(2).setText(2, _translate("allPaymetsOfPurchaseOrders", "1010"))
