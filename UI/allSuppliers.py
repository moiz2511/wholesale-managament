...
from newSupplier import Ui_newSupplier
import mysql.connector
from PyQt5.QtCore import Qt
from editSupplier import Ui_editSupplier

class Ui_viewSuppliers(object):
    def setupUi(self, viewSuppliers):
        ...
        self.actiontoolBarAddNewCustomer.triggered.connect(lambda:self.newSupplierFunc())
    ...
    def editFunc(self):
        ...
        self.ui.setupUi(self.window,Ui_viewSuppliers,self)
    ...
    def newSupplierFunc(self):
        self.window=QtWidgets.QMainWindow()
        self.ui=Ui_newSupplier()
        self.ui.setupUi(self.window,Ui_viewSuppliers,self)
        self.window.show()
    ...
    def loadData(self):
        ...
        for x in result:
            ...
            self.treeWidget.topLevelItem(i).setText(4,x[4])
            i=i+1
            self.vari=i
    ...
    def retranslateUi(self, viewSuppliers):
        ...
        viewSuppliers.setWindowTitle(_translate("viewSuppliers", "All Suppliers"))
        self.findInput.setPlaceholderText(_translate("viewSuppliers", "Find a Customer"))
        ...
        self.treeWidget.headerItem().setText(1, _translate("viewSuppliers", "Supplier"))
        self.treeWidget.headerItem().setText(2, _translate("viewSuppliers", "Amount Payable"))
        self.treeWidget.headerItem().setText(3, _translate("viewSuppliers", "Due Date"))
        self.treeWidget.headerItem().setText(4, _translate("viewSuppliers", "Phone Number"))
