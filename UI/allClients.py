...
class Ui_viewAllClients(object):
    def setupUi(self, viewSuppliers,first,firstSelf):
        self.found=[]
        self.vari=0
        ...
        self.actionSelect = QtWidgets.QAction(viewSuppliers)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap("C:/Users/MOIZ/Downloads/icons/plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSelect.setIcon(icon19)
        ...
        self.actionSelect.triggered.connect(lambda:sendData(self))
        ...
        def sendData(self):
            ...
            for x in sel:
                myId=int(x.text(0))
            first.loadDataa(self,myId,firstSelf)
            viewSuppliers.close()
    ...
    def editFunc(self):
        ...
        self.ui.setupUi(self.window,Ui_viewAllClients,self)
    ...
    def retranslateUi(self, viewSuppliers):
        ...
        self.actionSelect.setText(_translate("viewSuppliers", "Select"))
        self.actiontoolBarAddNewCustomer.setToolTip(_translate("viewSuppliers", "Add New Customer"))
        self.actionSelect.setToolTip(_translate("viewSuppliers", "Select this Customer"))
